...
public class XoOyun {
	public static void main(String[] args) {
		...
		do{
			...
			do{
				XOGoster(xo);
				System.out.println("Hamle Sýrasý 1. Oyuncuda:");
				...
				do{
					...
					if(!hamleKontrol)
					{
						System.out.println("Lütfen geçerli bir hamle yapýnýz");
						XOGoster(xo);
					}
				...
				if(tekrarOynama) System.out.println("Bir hak daha kazandýnýz");
				
			}while(tekrarOynama && oyunKontrol);
			
			do{
				XOGoster(xo);
				System.out.println("Hamle Sýrasý 2. Oyuncuda:");
	...
	public static void SonucGoster(String XO[][])
	{
		...
		System.out.println("1. Oyununcunun puaný = " + oyuncu1 +"\n 2. Oyuncunun Puaný = " + oyuncu2);

		if(oyuncu1 > oyuncu2)
		{
			System.out.println("1. oyuncu kazanmýþtýr.");
		}
		else if(oyuncu1 < oyuncu2)
		{
			System.out.println("2. oyuncu kazanmýþtýr");
		}
		else
		{
